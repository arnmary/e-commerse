...
export default function Aboutpage() {
  return (
    <>
       <section id="about" className="mb-5">
            <div className="row align-items-center">
                <div className="col-md-6">
                    <h2 className='inter-500'>Хто ми?</h2>
                    <p className='inter-400'> Petsmania — це зоомагазин, який допомагає вам піклуватися про ваших улюбленців. Ми пропонуємо широкий асортимент якісних товарів для тварин: від кормів до аксесуарів.</p>
       ...
       <div>
         <h2 className="text-center inter-500 fs-3 mb-4">Наша місія</h2>
        ...
        <section id="advantages" className="my-5">
            <h2 className="text-center inter-500 mb-4">Чому обирають нас?</h2>
            <div className="row text-center">
                <div className="col-md-4">
                    <i className="bi bi-star-fill text-warning fs-1"></i>
                    <h4 className="mt-2 inter-400">Висока якість</h4>
                    <p>Ми працюємо лише з перевіреними виробниками.</p>
                </div>
                <div className="col-md-4">
                    <i className="bi bi-truck text-success fs-1"></i>
                    <h4 className="mt-2 inter-400">Швидка доставка</h4>
                    <p className='inter-400'>Доставляємо ваші замовлення вчасно.</p>
                </div>
                <div className="col-md-4">
                    <i className="bi bi-heart-fill text-danger fs-1"></i>
                    <h4 className="mt-2 inter-400">Любов до тварин</h4>
                    <p className='inter-400'>Ми щиро любимо те, що робимо.</p>
                </div>
            </div>
        </section>

        <section id="gallery" className="my-5">
            <h2 className="text-center mb-4 inter-500">Наші улюбленці</h2>
